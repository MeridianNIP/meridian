...
_SENSITIVE_KEYS = frozenset({
    "password", "passwd", "pwd",
    "secret", "client_secret", "auth_token", "session_token", "session",
    "api_key", "apikey", "x-api-key", "authorization",
    "totp_secret", "mfa_secret", "backup_code", "backup_codes",
    "private_key", "privkey", "ed25519_private",
    "recovery_email", "recovery_phone",   # keep these out of audit too
    "ssn", "tax_id", "passport",
})
